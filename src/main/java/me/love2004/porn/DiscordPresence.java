...
public class DiscordPresence {
    ...
    public static void start() {
        ...
        rpc.Discord_Initialize("671258457772523530", handlers, true, "");
        ...
        DiscordPresence.presence.largeImageKey = "loveclientdiscord";
        DiscordPresence.presence.largeImageText = "loveclientdiscord";
