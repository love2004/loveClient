package me.love2004.porn.command;
...
public abstract class Command
    ...
    public static void sendMessage(String message, boolean notification) {
        Command.sendSilentMessage(loveClient.commandManager.getClientMessage() + " " + "\u00a7r" + message);
        if (notification) {
            loveClient.notificationManager.addNotification(message, 3000L);
        }
    }
    ...
    public static String getCommandPrefix() {
        return loveClient.commandManager.getPrefix();
    }
