...
import me.love2004.porn.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : loveClient.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : loveClient.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = loveClient.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = loveClient.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
