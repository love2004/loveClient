...
public class Cosmetics
    ...
    public void onRenderPlayer(RenderPlayerEvent.Post event) {
        if (!loveClient.cosmeticsManager.hasCosmetics(event.getEntityPlayer()) || EntityUtil.isFakePlayer(event.getEntityPlayer())) {
            return;
        }
        for (ModelBase model : loveClient.cosmeticsManager.getRenderModels(event.getEntityPlayer())) {
