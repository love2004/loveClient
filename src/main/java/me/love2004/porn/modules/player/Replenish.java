...
import me.love2004.porn.modules.combat.Auto32k;
...
public class Replenish
    ...
    public void onUpdate() {
        if (Auto32k.getInstance().isEnable() && (!Auto32k.getInstance().autoSwitch.getValue().booleanValue() || Auto32k.getInstance().switching)) {
            return;
        }
