...
import me.love2004.porn.event.events.KeyEvent;
...
public class NoSlowDown
    ...
    public void onUpdate() {
        ...
        if (this.webs.getValue().booleanValue() && loveClient.moduleManager.getModuleByClass(Flight.class).isDisabled() && loveClient.moduleManager.getModuleByClass(Phase.class).isDisabled() && NoSlowDown.mc.player.isInWeb) {
