...
public class LongJump
    ...
    public void onEnable() {
        ...
        if (Strafe.getInstance().isEnable() && this.disableStrafe.getValue()) {
    ...
    public void onTickEvent(final TickEvent.ClientTickEvent event) {
        ...
        if (Strafe.getInstance().isEnable() && this.strafeOff.getValue()) {
            this.disable();
            return;
        }
        ...
        switch (this.mode.getValue()) {
            ...
            case DIRECT: {
                ...
                if (!LongJump.mc.player.collidedVertically) {
                    ...
                    loveClient.timerManager.setTimer(0.85f);
