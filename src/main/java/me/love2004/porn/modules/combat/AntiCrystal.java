...
public class AntiCrystal
    ...
    private void placeCrystal(Entity deadlyCrystal) {
        ...
        if (this.timer.passedMs(this.placeDelay.getValue().intValue()) && (this.switcher.getValue() || AntiCrystal.mc.player.getHeldItemMainhand().getItem() == Items.END_CRYSTAL || offhand) && !this.targets.isEmpty() && this.getSafetyCrystals(deadlyCrystal) <= this.wasteAmount.getValue()) {
