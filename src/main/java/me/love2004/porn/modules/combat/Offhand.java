...
import me.love2004.porn.mixin.mixins.accessors.IContainer;
import me.love2004.porn.mixin.mixins.accessors.ISPacketSetSlot;
...
public class Offhand
    ...
    private boolean noNearbyPlayers() {
        return this.mode == Mode.CRYSTALS && Offhand.mc.world.playerEntities.stream().noneMatch(e -> e != Offhand.mc.player && !loveClient.friendManager.isFriend(e) && Offhand.mc.player.getDistance(e) <= this.cTargetDistance.getValue().floatValue());
    }
