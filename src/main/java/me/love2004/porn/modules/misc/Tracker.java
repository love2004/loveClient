...
import me.love2004.porn.event.events.ConnectionEvent;
...
import me.love2004.porn.modules.combat.AntiTrap;
...
public class Tracker
    ...
    public void onPacketSend(PacketEvent.Send event) {
        if (!Tracker.fullNullCheck() && this.isEnable() && event.getPacket() instanceof CPacketPlayerTryUseItemOnBlock) {
    ...
    public void onDeath(DeathEvent event) {
        if (this.isEnable() && (event.player.equals(this.trackedPlayer) || event.player.equals(Tracker.mc.player))) {
            this.usedExp = 0;
            this.usedStacks = 0;
            this.usedCrystals = 0;
            this.usedCStacks = 0;
